                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          '${(item.produit.price * item.quantity).toStringAsFixed(2)} DZD',
                          style: const TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 16,
                            color: Colors.green,
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(
                'Stock disponible: ${item.produit.quantity.toStringAsFixed(2)}',
                style: TextStyle(
                  fontSize: 12,
                  color: Colors.grey.shade600,
                ),
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                'Quantité actuelle: ${item.quantity.toStringAsFixed(2)}',
      ...
      final shouldApprove = await showDialog<bool>(
        ...
        builder:
            (context) => AlertDialog(
              ...
              content: const Text(
                'Cette action réduira les stocks. Continuer?',
              ),
              actions: [
                TextButton(
