      ...
      for (final item in order.items) {
        final product =
            await client
                ...
                .select(
                  '"Stock ( Unité )"',
                ) // Note the quotes around column name
        ...
        if (item.quantity > currentStock) {
          throw Exception('Stock insuffisant pour ${item.produit.name}');
        }
      }
        ...
        await client
            ...
            .update({
              'Stock ( Unité )':
                  ...
                  item.quantity, // Make sure your Produit model has a stock field
